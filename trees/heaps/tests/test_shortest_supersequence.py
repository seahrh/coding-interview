...
class TestShortestSupersequence(unittest.TestCase):
    def test_given_not_all_includes_are_found_then_return_none(self):
        self.assertEqual(shortest_supersequence([1, 2, 3], includes={1, 4}), None)

    def test_given_empty_array_then_return_none(self):
        self.assertEqual(shortest_supersequence([], includes={1, 4}), None)

    def test_given_array_of_length_one(self):
        self.assertEqual(shortest_supersequence([1], includes={1}), Range(0, 0))

    def test_given_array_of_length_two(self):
        self.assertEqual(shortest_supersequence([1, 2], includes={1}), Range(0, 0))

    def test_given_includes_of_length_two(self):
        self.assertEqual(shortest_supersequence([1, 2], includes={1, 2}), Range(0, 1))

    def test_given_example_1(self):
        self.assertEqual(shortest_supersequence(
